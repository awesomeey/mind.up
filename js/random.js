...
// main positioning after print random quote :: Responsive
// use Promise(), then() for detect the height of main after printing random quotes
function printQuote(){
...
function responsiveMain(){
	...
	if(mainHeight > windowHeight) main.classList.add('over-height');
	else main.classList.remove('over-height');
}

function renderResponsive(){
	printQuote().then(responsiveMain);
}
renderResponsive();
...
const darkBg = ['04', '06', '10', '11', '12', '17', '18', '20', '26', '27'];

background.className = `bg${bgIndex}`;
if(darkBg.indexOf(bgIndex) !== -1) document.body.classList.add('dark');
